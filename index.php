...
<body>
    ...
    <!-- Navigation -->
    <nav class="navbar navbar-default navbar-fixed-top" role="navigation" style="background:#e76d89">
        <div class="container" >
...
Before we can look into the php code, you need to create a database called "feed" with two tables in it..one as student and another one as take
	...
	<div class="navbar-fixed-bottom nav navbar-inverse text-center" style="padding:15px;height:40px; background:#e76d89">
		<span style="color:#FFFFFF">Developed By ....... 	<a href="https://www.facebook.com/Soldier.al.bibak">Alamin</a> </span>
	</div>
    <!-- jQuery -->
